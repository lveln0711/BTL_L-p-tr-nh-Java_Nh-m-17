...
public class ProductView {
    ...
    private void buildUI() {
        ...
        typeCol.setCellValueFactory(d -> new SimpleStringProperty(d.getValue().getProductType()));
        typeCol.setPrefWidth(70);

        TableColumn<Product, String> idCol = new TableColumn<>("Mã SP");
        idCol.setCellValueFactory(d -> new SimpleStringProperty(d.getValue().getProductId()));
        ...
        priceCol.setCellValueFactory(d -> new SimpleStringProperty(String.format("%,.0f", d.getValue().getProductPrice())));
        ...
        table.getColumns().setAll(List.of(typeCol, idCol, nameCol, brandCol, priceCol, qtyCol, specCol));
        ...
        tfSearch.textProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal == null || newVal.trim().isEmpty()) {
                ...
                List<Product> result = AppContext.PRODUCT_MANAGER.searchProductsByName(newVal);
        ...
        btnDelete.setOnAction(e -> {
            ...
            if (confirm) {
                boolean ok = AppContext.PRODUCT_MANAGER.deleteProductById(selected.getProductId());
                if (ok) {
    ...
    private void showAddDialog() {
        ...
        cbType.setOnAction(e -> updateSpecLabels(cbType.getValue(), lblSpec1, lblSpec2, tfSpec1, tfSpec2));
    ...
    private void updateSpecLabels(String type, Label lbl1, Label lbl2, TextField tf1, TextField tf2) {
        switch (type) {
            case "PHONE" -> {
    ...
    private Product buildProductFromForm(String type,TextField tfId,TextField tfName,TextField tfBrand,TextField tfPrice,TextField tfQty,TextField tfSpec1,TextField tfSpec2) {
        try {
