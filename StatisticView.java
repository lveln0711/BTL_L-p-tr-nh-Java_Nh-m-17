...
public class StatisticView {
    ...
    public void refresh() {
        ...
        Label productCount = new Label("Tổng sản phẩm  : " + productManager.getTotalProducts());
        Label customerCount = new Label("Tổng khách hàng: " + customerManager.getTotalCustomers());
        Label invoiceCount = new Label("Tổng hóa đơn   : " + invoiceManager.getTotalInvoices());
        Label revenue = new Label(String.format("Tổng doanh thu : %,.0f VNĐ", invoiceManager.getTotalRevenue()));
        ...
        PieChart chart = new PieChart(buildChart(productManager.getAllProducts()));
        chart.setTitle("Cơ cấu sản phẩm theo loại");
        chart.setPrefHeight(300);

        VBox box = new VBox(10, title, productCount, customerCount, invoiceCount, revenue, chart);
